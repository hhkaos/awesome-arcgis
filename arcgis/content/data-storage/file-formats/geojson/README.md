...
* **Consumable by**:
    * [ArcGIS Online](../../../../products/arcgis-online/README.md) - [How to](https://developers.arcgis.com/labs/arcgisonline/import-data/) (or using [geojson2fs-service](https://github.com/esri-es/geojson2fs-service))
