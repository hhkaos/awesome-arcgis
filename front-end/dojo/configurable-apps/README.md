...
* [swipe-map-storytelling-template-js](https://github.com/Esri/swipe-map-storytelling-template-js): A storytelling template that enables users to reveal a layer of a web map or another web map using a vertical bar or a spy glass.
...
* [Viewer](https://github.com/Esri/Viewer): Viewer is a configurable application template that enables you to display an ArcGIS web map using a variety of tools.
