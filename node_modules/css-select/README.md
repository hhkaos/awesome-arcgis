...
- [css-select * * * *](#css-select----)
  ...
  - [API](#api)
      - [`CSSselect(query, elems, options)`](#cssselectquery-elems-options)
      - [`CSSselect.compile(query)`](#cssselectcompilequery)
      - [`CSSselect.is(elem, query, options)`](#cssselectiselem-query-options)
      - [`CSSselect.selectOne(query, elems, options)`](#cssselectselectonequery-elems-options)
    - [Options](#options)
