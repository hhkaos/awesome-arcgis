...
- [event-emitter](#event-emitter)
  - [Environment agnostic event emitter](#environment-agnostic-event-emitter)
    - [Installation](#installation)
    - [Usage](#usage)
    - [Additional utilities](#additional-utilities)
      - [allOff(obj) _(event-emitter/all-off)_](#alloffobj-_event-emitterall-off_)
      - [hasListeners(obj[, name]) _(event-emitter/has-listeners)_](#haslistenersobj-name-_event-emitterhas-listeners_)
      - [pipe(source, target[, emitMethodName]) _(event-emitter/pipe)_](#pipesource-target-emitmethodname-_event-emitterpipe_)
      - [unify(emitter1, emitter2) _(event-emitter/unify)_](#unifyemitter1-emitter2-_event-emitterunify_)
    - [Tests *](#tests-)
