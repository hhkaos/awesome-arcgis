...
- [plugin-fontsettings](#plugin-fontsettings)
    - [Disable this plugin](#disable-this-plugin)
    - [Configuration](#configuration)
    - [Plugin API](#plugin-api)
      - [Font manipulation](#font-manipulation)
        - [`gitbook.fontsettings.enlargeFontSize()`](#gitbookfontsettingsenlargefontsize)
        - [`gitbook.fontsettings.reduceFontSize()`](#gitbookfontsettingsreducefontsize)
      - [Font families](#font-families)
        - [CSS rules](#css-rules)
        - [Managing the font families](#managing-the-font-families)
        - [`gitbook.fontsettings.getFamilies()`](#gitbookfontsettingsgetfamilies)
        - [`gitbook.fontsettings.setFamilies()`](#gitbookfontsettingssetfamilies)
        - [`gitbook.fontsettings.setFamily()`](#gitbookfontsettingssetfamily)
      - [Color themes](#color-themes)
        - [CSS rules](#css-rules-1)
        - [Managing the color themes](#managing-the-color-themes)
        - [`gitbook.fontsettings.getFamilies()`](#gitbookfontsettingsgetfamilies-1)
        - [`gitbook.fontsettings.setThemes()`](#gitbookfontsettingssetthemes)
        - [`gitbook.fontsettings.setTheme()`](#gitbookfontsettingssettheme)
