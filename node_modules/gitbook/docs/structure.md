...
- [Directory Structure](#directory-structure)
    - [Static files and Images](#static-files-and-images)
    - [Ignoring files & folders {#ignore}](#ignoring-files--folders-ignore)
    - [Project integration with subdirectory {#subdirectory}](#project-integration-with-subdirectory-subdirectory)
