...
- [Introduction](#introduction)
  - [Object](#object)
    - [clone(obj)](#cloneobj)
    - [cloneWithShallow(obj, keys)](#clonewithshallowobj-keys)
    - [merge(target, source, isNullOverride, isMergeArrays)](#mergetarget-source-isnulloverride-ismergearrays)
    - [applyToDefaults(defaults, options, isNullOverride)](#applytodefaultsdefaults-options-isnulloverride)
    - [applyToDefaultsWithShallow(defaults, options, keys)](#applytodefaultswithshallowdefaults-options-keys)
    - [deepEqual(b, a, [options])](#deepequalb-a-options)
    - [unique(array, key)](#uniquearray-key)
    - [mapToObject(array, key)](#maptoobjectarray-key)
    - [intersect(array1, array2)](#intersectarray1-array2)
    - [contain(ref, values, [options])](#containref-values-options)
    - [flatten(array, [target])](#flattenarray-target)
    - [reach(obj, chain, [options])](#reachobj-chain-options)
    - [reachTemplate(obj, template, [options])](#reachtemplateobj-template-options)
    - [transform(obj, transform, [options])](#transformobj-transform-options)
    - [shallow(obj)](#shallowobj)
    - [stringify(obj)](#stringifyobj)
- [Timer](#timer)
- [Bench](#bench)
- [Binary Encoding/Decoding](#binary-encodingdecoding)
    - [base64urlEncode(value)](#base64urlencodevalue)
    - [base64urlDecode(value)](#base64urldecodevalue)
- [Escaping Characters](#escaping-characters)
    - [escapeHtml(string)](#escapehtmlstring)
    - [escapeHeaderAttribute(attribute)](#escapeheaderattributeattribute)
    - [escapeRegex(string)](#escaperegexstring)
- [Errors](#errors)
    - [assert(condition, message)](#assertcondition-message)
    - [abort(message)](#abortmessage)
    - [displayStack(slice)](#displaystackslice)
    - [callStack(slice)](#callstackslice)
  - [Function](#function)
    - [nextTick(fn)](#nexttickfn)
    - [once(fn)](#oncefn)
    - [ignore](#ignore)
  - [Miscellaneous](#miscellaneous)
    - [uniqueFilename(path, extension)](#uniquefilenamepath-extension)
    - [isAbsolutePath(path, [platform])](#isabsolutepathpath-platform)
    - [isInteger(value)](#isintegervalue)
