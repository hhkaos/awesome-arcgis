...
- [ignore](#ignore)
        - [Tested on](#tested-on)
  - [Table Of Main Contents](#table-of-main-contents)
  - [Usage](#usage)
    - [Filter the given paths](#filter-the-given-paths)
    - [As the filter function](#as-the-filter-function)
    - [Win32 paths will be handled](#win32-paths-will-be-handled)
  - [Why another ignore?](#why-another-ignore)
  - [Methods](#methods)
    - [.add(pattern)](#addpattern)
    - [.add(patterns)](#addpatterns)
    - [<strike>.addIgnoreFile(path)</strike>](#strikeaddignorefilepathstrike)
    - [.filter(paths)](#filterpaths)
    - [.createFilter()](#createfilter)
  - [Upgrade 2.x -> 3.x](#upgrade-2x---3x)
