...
- [Immutable collections for JavaScript](#immutable-collections-for-javascript)
  - [Getting started](#getting-started)
    - [Browser](#browser)
    - [TypeScript](#typescript)
  - [The case for Immutability](#the-case-for-immutability)
  - [JavaScript-first API](#javascript-first-api)
    - [Accepts raw JavaScript objects.](#accepts-raw-javascript-objects)
    - [Converts back to raw JavaScript objects.](#converts-back-to-raw-javascript-objects)
    - [Embraces ES6](#embraces-es6)
  - [Nested Structures](#nested-structures)
  - [Lazy Seq](#lazy-seq)
  - [Equality treats Collections as Data](#equality-treats-collections-as-data)
