...
- [jsprim: utilities for primitive JavaScript types](#jsprim-utilities-for-primitive-javascript-types)
    - [deepCopy(obj)](#deepcopyobj)
    - [deepEqual(obj1, obj2)](#deepequalobj1-obj2)
    - [isEmpty(obj)](#isemptyobj)
    - [hasKey(obj, key)](#haskeyobj-key)
    - [forEachKey(obj, callback)](#foreachkeyobj-callback)
    - [flattenObject(obj, depth)](#flattenobjectobj-depth)
    - [flattenIter(obj, depth, func)](#flatteniterobj-depth-func)
    - [pluck(obj, key)](#pluckobj-key)
    - [randElt(array)](#randeltarray)
    - [startsWith(str, prefix)](#startswithstr-prefix)
    - [endsWith(str, suffix)](#endswithstr-suffix)
    - [parseInteger(str, options)](#parseintegerstr-options)
    - [iso8601(date)](#iso8601date)
    - [parseDateTime(str)](#parsedatetimestr)
    - [hrtimeDiff(timeA, timeB)](#hrtimedifftimea-timeb)
    - [hrtimeAdd(timeA, timeB)](#hrtimeaddtimea-timeb)
    - [hrtimeAccum(timeA, timeB)](#hrtimeaccumtimea-timeb)
    - [hrtimeNanosec(timeA), hrtimeMicrosec(timeA), hrtimeMillisec(timeA)](#hrtimenanosectimea-hrtimemicrosectimea-hrtimemillisectimea)
    - [validateJsonObject(schema, object)](#validatejsonobjectschema-object)
    - [extraProperties(object, allowed)](#extrapropertiesobject-allowed)
    - [mergeObjects(provided, overrides, defaults)](#mergeobjectsprovided-overrides-defaults)
