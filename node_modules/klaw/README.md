...
- [Node.js - klaw](#nodejs---klaw)
  - [Install](#install)
  - [Name](#name)
  - [Usage](#usage)
    - [klaw(directory, [options])](#klawdirectory-options)
    - [Error Handling](#error-handling)
    - [Aggregation / Filtering / Executing Actions (Through Streams)](#aggregation--filtering--executing-actions-through-streams)
