...
- [kramed](#kramed)
  - [Install](#install)
    - [Why fork `marked` ?](#why-fork-marked-)
  - [Usage](#usage)
  - [kramed(markdownString [,options] [,callback])](#kramedmarkdownstring-options-callback)
    - [markdownString](#markdownstring)
    - [options](#options)
    - [callback](#callback)
  - [Options](#options)
    - [highlight](#highlight)
      - [highlight arguments](#highlight-arguments)
    - [renderer](#renderer)
      - [Overriding renderer methods](#overriding-renderer-methods)
      - [Block level renderer methods](#block-level-renderer-methods)
      - [Inline level renderer methods](#inline-level-renderer-methods)
    - [gfm](#gfm)
    - [tables](#tables)
    - [breaks](#breaks)
    - [pedantic](#pedantic)
  ...
  - [CLI](#cli)
  - [Philosophy behind kramed](#philosophy-behind-kramed)
