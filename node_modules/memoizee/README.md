...
- [Memoizee](#memoizee)
  - [Complete memoize/cache solution for JavaScript](#complete-memoizecache-solution-for-javascript)
    - [Features](#features)
    ...
    - [Configuration](#configuration)
      ...
      - [Memoizing methods](#memoizing-methods)
      - [WeakMap based configurations](#weakmap-based-configurations)
      - [Cache handling](#cache-handling)
        - [Manual clean up:](#manual-clean-up)
        - [Expire cache after given period of time](#expire-cache-after-given-period-of-time)
        - [Reference counter](#reference-counter)
        - [Limiting cache size](#limiting-cache-size)
        - [Registering dispose callback](#registering-dispose-callback)
