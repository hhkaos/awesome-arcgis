...
- [Optionator](#optionator)
  ...
  - [About](#about)
  - [Usage](#usage)
    - [parse(input, parseOptions)](#parseinput-parseoptions)
        - [arguments](#arguments)
        - [returns](#returns)
        - [example](#example)
    - [parseArgv(input)](#parseargvinput)
        - [arguments](#arguments-1)
        - [returns](#returns-1)
        - [example](#example-1)
    - [generateHelp(helpOptions)](#generatehelphelpoptions)
        - [arguments](#arguments-2)
        - [returns](#returns-2)
        - [example](#example-2)
    - [generateHelpForOption(optionName)](#generatehelpforoptionoptionname)
  ...
  - [Settings Format](#settings-format)
    - [Top Level Properties](#top-level-properties)
      ...
      - [Help Style Properties](#help-style-properties)
  - [Argument Format](#argument-format)
  - [Technical About](#technical-about)
