...
- [API reference](#api-reference)
  - [Enum: TreeAdapters](#enum-treeadapters)
    - [&bull; TreeAdapters.default](#bull-treeadaptersdefault)
    - [&bull; TreeAdapters.htmlparser2](#bull-treeadaptershtmlparser2)
  - [Class: Parser](#class-parser)
    - [&bull; Parser.ctor([treeAdapter, options])](#bull-parserctortreeadapter-options)
      - [options.decodeHtmlEntities](#optionsdecodehtmlentities)
      - [options.locationInfo](#optionslocationinfo)
    - [&bull; Parser.parse(html)](#bull-parserparsehtml)
    - [&bull; Parser.parseFragment(htmlFragment, [contextElement])](#bull-parserparsefragmenthtmlfragment-contextelement)
  - [Class: SimpleApiParser](#class-simpleapiparser)
    - [&bull; SimpleApiParser.ctor(handlers, [options])](#bull-simpleapiparserctorhandlers-options)
      - [options.decodeHtmlEntities](#optionsdecodehtmlentities-1)
      - [options.locationInfo](#optionslocationinfo-1)
    - [&bull; SimpleApiParser.parse(html)](#bull-simpleapiparserparsehtml)
  - [Class: Serializer](#class-serializer)
    - [&bull; Serializer.ctor([treeAdapter, options])](#bull-serializerctortreeadapter-options)
      - [options.encodeHtmlEntities](#optionsencodehtmlentities)
    - [&bull; Serializer.serialize(node)](#bull-serializerserializenode)
- [Testing](#testing)
- [Custom tree adapter](#custom-tree-adapter)
