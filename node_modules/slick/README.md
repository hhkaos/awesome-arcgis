...
- [Slick](#slick)
  - [The Finder](#the-finder)
    - [`search` context for selector](#search-context-for-selector)
    - [`find` first in context with selector or null](#find-first-in-context-with-selector-or-null)
    - [node `matches` selector?](#node-matches-selector)
    - [context `contains` node?](#context-contains-node)
  - [The Parser](#the-parser)
    - [`parse` selector into object](#parse-selector-into-object)
    - [format](#format)
    - [`#foo > bar.baz`](#foo--barbaz)
    - [`h1, h2, ul > li, .things`](#h1-h2-ul--li-things)
