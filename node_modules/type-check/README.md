...
- [type-check *](#type-check-)
  ...
  - [Usage](#usage)
    - [typeCheck(type, input, options)](#typechecktype-input-options)
        - [arguments](#arguments)
        - [returns](#returns)
        - [example](#example)
    - [parseType(type)](#parsetypetype)
        - [arguments](#arguments-1)
        - [returns](#returns-1)
        - [example](#example-1)
    - [parsedTypeCheck(parsedType, input, options)](#parsedtypecheckparsedtype-input-options)
