...
- [UglifyJS 2](#uglifyjs-2)
  ...
  - [Mangler options](#mangler-options)
    - [Mangling property names (`--mangle-props`)](#mangling-property-names---mangle-props)
      - [Mangling unquoted names (`--mangle-props=unquoted` or `--mangle-props=2`)](#mangling-unquoted-names---mangle-propsunquoted-or---mangle-props2)
  ...
  - [Support for the SpiderMonkey AST](#support-for-the-spidermonkey-ast)
    ...
    - [Using UglifyJS to transform SpiderMonkey AST](#using-uglifyjs-to-transform-spidermonkey-ast)
  - [API Reference](#api-reference)
    ...
    - [The hard way](#the-hard-way)
      ...
      - [Generating a source mapping](#generating-a-source-mapping)
      - [Support for `const`](#support-for-const)
