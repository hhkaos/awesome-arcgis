...
- [verror: rich JavaScript errors](#verror-rich-javascript-errors)
- [Quick start](#quick-start)
- [Deeper dive](#deeper-dive)
- [Reference: VError, WError, SError](#reference-verror-werror-serror)
  - [Constructors](#constructors)
  - [Public properties](#public-properties)
  - [Class methods](#class-methods)
    - [`VError.cause(err)`](#verrorcauseerr)
    - [`VError.info(err)`](#verrorinfoerr)
    - [`VError.fullStack(err)`](#verrorfullstackerr)
    - [`VError.findCauseByName(err, name)`](#verrorfindcausebynameerr-name)
    - [`VError.hasCauseWithName(err, name)`](#verrorhascausewithnameerr-name)
    - [`VError.errorFromList(errors)`](#verrorerrorfromlisterrors)
    - [`VError.errorForEach(err, func)`](#verrorerrorforeacherr-func)
  - [Examples](#examples)
