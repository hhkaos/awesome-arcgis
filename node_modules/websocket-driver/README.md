...
- [websocket-driver *](#websocket-driver-)
  ...
  - [Usage](#usage)
    - [Server-side with HTTP](#server-side-with-http)
    - [Server-side with TCP](#server-side-with-tcp)
    - [Client-side](#client-side)
    - [HTTP Proxies](#http-proxies)
    - [Driver API](#driver-api)
      - [`driver.on('open', function(event) {})`](#driveronopen-functionevent-)
      - [`driver.on('message', function(event) {})`](#driveronmessage-functionevent-)
      - [`driver.on('error', function(event) {})`](#driveronerror-functionevent-)
      - [`driver.on('close', function(event) {})`](#driveronclose-functionevent-)
      - [`driver.on('ping', function(event) {})`](#driveronping-functionevent-)
      - [`driver.on('pong', function(event) {})`](#driveronpong-functionevent-)
      - [`driver.addExtension(extension)`](#driveraddextensionextension)
      - [`driver.setHeader(name, value)`](#driversetheadername-value)
      - [`driver.start()`](#driverstart)
      - [`driver.parse(string)`](#driverparsestring)
      - [`driver.text(string)`](#drivertextstring)
      - [`driver.binary(buffer)`](#driverbinarybuffer)
      - [`driver.ping(string = '', function() {})`](#driverpingstring---function-)
      - [`driver.pong(string = '')`](#driverpongstring--)
      - [`driver.close()`](#driverclose)
      - [`driver.version`](#driverversion)
      - [`driver.protocol`](#driverprotocol)
