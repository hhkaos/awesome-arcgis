...
- [yargs](#yargs)
- [examples](#examples)
  - [With yargs, the options be just a hash!](#with-yargs-the-options-be-just-a-hash)
  - [But don't walk the plank just yet! There be more! You can do short options:](#but-dont-walk-the-plank-just-yet-there-be-more-you-can-do-short-options)
  - [And booleans, both long, short, and even grouped:](#and-booleans-both-long-short-and-even-grouped)
  - [And non-hyphenated options too! Just use `argv._`!](#and-non-hyphenated-options-too-just-use-argv_)
  - [Yargs even counts your booleans!](#yargs-even-counts-your-booleans)
  - [Tell users how to use yer options and make demands.](#tell-users-how-to-use-yer-options-and-make-demands)
  - [After yer demands have been met, demand more! Ask for non-hypenated arguments!](#after-yer-demands-have-been-met-demand-more-ask-for-non-hypenated-arguments)
  - [EVEN MORE SHIVER ME TIMBERS!](#even-more-shiver-me-timbers)
  - [And if you really want to get all descriptive about it...](#and-if-you-really-want-to-get-all-descriptive-about-it)
  - [Yargs is here to help you...](#yargs-is-here-to-help-you)
- [methods](#methods)
  - [.alias(key, alias)](#aliaskey-alias)
  - [.default(key, value, [description])](#defaultkey-value-description)
  - [.demand(key, [msg | boolean])](#demandkey-msg--boolean)
  ...
  - [.usage(message, opts)](#usagemessage-opts)
  - [.command(cmd, desc, [fn])](#commandcmd-desc-fn)
  ...
  - [.version(version, [option], [description])](#versionversion-option-description)
  - [.showHelpOnFail(enable, [message])](#showhelponfailenable-message)
  - [.showHelp(consoleLevel='error')](#showhelpconsolelevelerror)
  ...
  - [.reset()](#reset)
  - [.argv](#argv)
- [parsing tricks](#parsing-tricks)
  - [stop parsing](#stop-parsing)
  - [negate fields](#negate-fields)
  - [numbers](#numbers)
